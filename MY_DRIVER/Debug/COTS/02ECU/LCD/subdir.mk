...
C_SRCS += \
../COTS/02ECU/LCD/LCD_program.c 

OBJS += \
./COTS/02ECU/LCD/LCD_program.o 

C_DEPS += \
./COTS/02ECU/LCD/LCD_program.d 


# Each subdirectory must supply rules for building sources it contributes
COTS/02ECU/LCD/%.o COTS/02ECU/LCD/%.su COTS/02ECU/LCD/%.cyclo: ../COTS/02ECU/LCD/%.c COTS/02ECU/LCD/subdir.mk
...
clean: clean-COTS-2f-02ECU-2f-LCD

clean-COTS-2f-02ECU-2f-LCD:
	-$(RM) ./COTS/02ECU/LCD/LCD_program.cyclo ./COTS/02ECU/LCD/LCD_program.d ./COTS/02ECU/LCD/LCD_program.o ./COTS/02ECU/LCD/LCD_program.su

.PHONY: clean-COTS-2f-02ECU-2f-LCD
